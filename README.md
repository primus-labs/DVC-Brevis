...
```json
{
  "private_data": [
    {
      "id": "passKycLevel",
      "salt": "5bee51fa2b9541d13a981f482d67b67c",
      "content": [
        "INTERMEDIATE"
      ]
    },
    {
      "id": "userId",
      "salt": "dd6056cd67cdefbe1c1a49c24198a348",
      "content": [
        "782151446"
      ]
    },
    {
      "id": "data",
      "salt": "fa0ab35d2863eda19cb3907eb6e8e5eb",
      "content": [
...
- **Description**: Verifies a user's OKX user ID, KYC level, and past 6 months trading history list.
...
- **Computation via zkVM**
  ...
  - **Transaction Activity**: Parses the `data` array to count the total number of trade entries from the trading history. Compares this count against the transaction threshold provided by the business rules (e.g., > 50 trades). *(zkVM Public: Comparison Result)*
...
```json
{
  "private_data": [
    {
      "id": "kycLevel",
      "salt": "0c9a4d0889663c5be0ac080cd820ef86",
      "content": [
        "2"
      ]
    },
    {
      "id": "uuid",
      "salt": "51d04177f6c72a09e089927de20609cf",
      "content": [
        "368977816601172152"
      ]
    },
    {
      "id": "data",
      "salt": "0e56b098060dbc1e9714df5b99f521f8",
      "content": [
        "[{\"bal\":\"0.4998749937496875\",\"balChg\":\"0.4998749937496875\",\"billId\":\"3384574638364991490\",\"ccy\":\"USDC\",\"clOrdId\":\"settleBlk17733705845030566\",\"displayId\":\"\",\"earnAmt\":\"\",\"earnApr\":\"\",\"execType\":\"\",\"fee\":\"0\",\"fillFwdPx\":\"\",\"fillIdxPx\":\"1\",\"fillMarkPx\":\"\",\"fillMarkVol\":\"\",\"fillPxUsd\":\"\",\"fillPxVol\":\"\",\"fillTime\":\"1773370584517\",\"from\":\"\",\"fromDesc\":\"\",\"instId\":\"USDT-USDC\",\"instType\":\"CONVERT\",\"interest\":\"0\",\"mgnMode\":\"cash\",\"modifyTime\":1773370584517,\"notes\":\"\",\"ordId\":\"3384574638297882624\",\"pnl\":\"0\",\"posBal\":\"0\",\"posBalChg\":\"0\",\"price\":\"0.999749987499375\",\"ruleType\":\"\",\"sId\":\"0\",\"side\":\"\",\"subType\":\"318\",\"subTypeDesc\":\"闪兑买入\",\"sz\":\"0.4998749937496875\",\"tag\":\"\",\"to\":\"\",\"toDesc\":\"\",\"tradeId\":\"3384574638243160064\",\"ts\":\"1773370584517\",\"type\":\"27\",\"typeDesc\":\"闪兑\"},{\"bal\":\"0\",\"balChg\":\"-0.5\",\"billId\":\"3384574638364991489\",\"ccy\":\"USDT\",\"clOrdId\":\"settleBlk17733705845030566\",\"displayId\":\"\",\"earnAmt\":\"\",\"earnApr\":\"\",\"execType\":\"\",\"fee\":\"0\",\"fillFwdPx\":\"\",\"fillIdxPx\":\"1\",\"fillMarkPx\":\"\",\"fillMarkVol\":\"\",\"fillPxUsd\":\"\",\"fillPxVol\":\"\",\"fillTime\":\"1773370584517\",\"from\":\"\",\"fromDesc\":\"\",\"instId\":\"USDT-USDC\",\"instType\":\"CONVERT\",\"interest\":\"0\",\"mgnMode\":\"cash\",\"modifyTime\":1773370584517,\"notes\":\"\",\"ordId\":\"3384574638297882624\",\"pnl\":\"0\",\"posBal\":\"0\",\"posBalChg\":\"0\",\"price\":\"0.999749987499375\",\"ruleType\":\"\",\"sId\":\"0\",\"side\":\"\",\"subType\":\"319\",\"subTypeDesc\":\"闪兑卖出\",\"sz\":\"0.5\",\"tag\":\"\",\"to\":\"\",\"toDesc\":\"\",\"tradeId\":\"3384574638243160064\",\"ts\":\"1773370584517\",\"type\":\"27\",\"typeDesc\":\"闪兑\"}]"
      ]
    }
  ]
}
...
- **zkTLS Verified Fields (`data` object)**:
  ...
  - `github_id_in_html`: The `profile_user_id` extracted from the HTML metadata of the profile being viewed (e.g., `8588607`).
...
```json
{
  "private_data": [
    {
      "id": "contribution",
      "salt": "c6067cc6b0d8442b8b6efd6ee17a52e9",
      "content": [
        "726\n      contributions\n        in the last year"
      ]
    },
    {
      ...
      "salt": "1fd58d2310ce3279f01972c7b6efba46",
      "content": [
        "{&quot;event_type&quot;:&quot;user_profile.click&quot;,&quot;payload&quot;:{&quot;profile_user_id&quot;:8588607,&quot;target&quot;:&quot;CONTRIBUTION_YEAR_LINK&quot;,&quot;user_id&quot;:8588607,&quot;originating_url&quot;:&quot;https://github.com/fksyuan?action=show&amp;controller=profiles&amp;tab=contributions&amp;user_id=fksyuan&quot;}}"
      ]
    },
    {
      "id": "github_id",
      "salt": "d7a112e0962a5da2f7fa49b9137101f4",
      "content": [
        "https://avatars.githubusercontent.com/u/8588607?v=4"
      ]
    },
    {
      "id": "years",
      "salt": "a3ce669507ffbe91da6569d0a9bbb612",
      "content": [
        "2026",
        "2025",
        "2024",
...
```json
{
  "private_data": [
    {
      "id": "profile_info",
      "salt": "b06240a67f8c8abf4efe335a3d9565a5",
      "content": [
        "<a href=\"https://steamcommunity.com/profiles/76561198382985081/\" aria-label=\"View your profile\">\n\t\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"https://avatars.akamai.steamstatic.com/fef49e7fa7e1997310d705b2a6158ff8dc1cdfeb_full.jpg\" alt=\"goose_eggsss\">\t\t\t\t\t\t\t\t\t\t\t\t</a>"
      ]
    },
    {
      "id": "purchase_history",
      "salt": "9eab927f57e98fe006db76ea3a60bb79",
      "content": [
...
- **Description**: Verifies the user's registered email, account age, and order counts.
...
- **zkTLS Verified Fields (`data` object)**:
  ...
  - `last_3_months_orders`: An HTML snippet containing the number of orders placed in the past 3 months (e.g., "0 orders").

  - `year_2025_orders`: An HTML snippet containing the number of orders placed in the year 2025 (e.g., 0 orders).
